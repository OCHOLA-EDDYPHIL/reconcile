...
PUBLIC_SCHEMAS: dict[str, type[BaseModel]] = {
    ...
    "recovery-dispatch-receipt": RecoveryDispatchReceipt,
    ...
    "recovery-policy-comparison": RecoveryPolicyComparison,
    "recovery-qualification-claim-authorization": (
        RecoveryQualificationClaimAuthorization
    ),
    "recovery-qualification-comparison": RecoveryQualificationComparison,
    "recovery-qualification-contention": RecoveryQualificationContention,
    "recovery-qualification-environment": RecoveryQualificationEnvironment,
    "recovery-qualification-index": RecoveryQualificationIndex,
    "recovery-qualification-manifest": RecoveryQualificationManifest,
    "recovery-qualification-results": RecoveryQualificationResults,
